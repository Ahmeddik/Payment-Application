...
ST_accountsDB_t accountsDB[10] = {
    ...
    {3000.0, RUNNING, "8189374615436851"},
    {100000.0, BLOCKED, "5807007076043875"},
...
EN_transState_t recieveTransactionData(ST_transaction_t* transData)
{
    if (isValidAccount(&(transData->cardHolderData), accountsDB) == ACCOUNT_NOT_FOUND)
        ...
        accountsDB[lastTransactionSequenceNumber].balance -= transData->terminalData.transAmount;
...
void recieveTransactionDataTest(void) {
    ...
    strcpy_s(transData1.cardHolderData.cardHolderName, sizeof(transData1.cardHolderData.cardHolderName), "John Doe");
    strcpy_s(transData1.cardHolderData.primaryAccountNumber, sizeof(transData1.cardHolderData.primaryAccountNumber), "1234567890123456");
    strcpy_s(transData1.cardHolderData.cardExpirationDate, sizeof(transData1.cardHolderData.cardExpirationDate), "12/25");
    transData1.terminalData.transAmount = 500.0;
    transData1.terminalData.maxTransAmount = 1000.0;
    strcpy_s(transData1.terminalData.transactionDate, sizeof(transData1.terminalData.transactionDate), "04/08/2024");
